...
⭐ Star the repo if NERVE helped you save money and make your work easier.

</h3>

[![Stars](https://img.shields.io/github/stars/diegosouzapw/Nerve?style=social)](https://github.com/diegosouzapw/Nerve)
<a href="https://trendshift.io/repositories/23589" target="_blank"><img src="https://trendshift.io/api/badge/repositories/23589" alt="diegosouzapw%2FNerve | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
[![Star History Rank](https://api.star-history.com/badge?repo=diegosouzapw/Nerve&theme=dark)](https://www.star-history.com/diegosouzapw/nerve)
...
[![Telegram](https://img.shields.io/badge/Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/nerveOficial)
...
[![Website](https://img.shields.io/badge/Website-nerve.online-blue?logo=google-chrome&logoColor=white)](https://nerve.online)

**Questions, provider tips, roadmap & support → [Discord](https://discord.gg/U47eFqAXCn) · [Telegram](https://t.me/nerveOficial) · WhatsApp [🌍 Global](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t) / [🇧🇷 Brasil](https://chat.whatsapp.com/LTSpdFhXTxjH4R6CCNiKWz)**

<br/>

## 🧩 Available

[![npm version](https://img.shields.io/npm/v/nerve?color=cb3837&logo=npm)](https://www.npmjs.com/package/nerve)
![NPM Monthly](https://img.shields.io/npm/dm/nerve?label=npm/month&color=cb3837&logo=npm)
[![Docker Hub](https://img.shields.io/docker/v/diegosouzapw/nerve?label=Docker%20Hub&logo=docker&color=2496ED)](https://hub.docker.com/r/diegosouzapw/nerve)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/nerve?label=docker%20pulls&logo=docker&color=2496ED)
![Electron Downloads](https://img.shields.io/github/downloads/diegosouzapw/nerve/total?style=flat&label=electron%20downloads&logo=electron&color=47848F)
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="#-why-nerve">🤔 Why Nerve</a></td>
    <td align="center"><a href="#-what-sets-nerve-apart">🏆 What Sets Apart</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><a href="#%EF%B8%8F-where-nerve-runs--anywhere">🖥️ Where It Runs</a></td>
    <td align="center"><a href="#-private--local-first">🔒 Private</a></td>
  </tr>
  <tr>
    <td align="right"><b>👀 See it</b></td>
    <td align="center"><a href="#-nerve-in-action">🎬 In Action</a></td>
  ...
  <tr>
    ...
    <td align="center"><a href="#-support-nerve">💚 Support / Donate</a></td>
...
<img src="./docs/diagrams/works-zero-config.svg" width="100%" alt="Works the second you install it — zero config. Three steps: 1. Install — npm i -g nerve, server boots on localhost:20128. 2. Point your tool at http://localhost:20128/v1 — any OpenAI-compatible tool (Claude Code, Cursor, Cline). 3. It answers — call model auto for an instant reply, with no API key, no signup, no configuration. Keyless free providers OpenCode Free and Felo are pre-wired into the auto combo, so a fresh install responds out of the box."/>
...
<sub>Prefer a specific free backend? Call it directly, e.g. `oc/…` (OpenCode Free) or `felo/…` (Felo). Then graduate to `auto` and let Nerve pick.</sub>
...
<p align="center">
  <a href="https://www.kimi.com/code?aff=nerve">
    <img src="public/sponsors/kimi-k3-banner.png" width="100%" alt="Kimi K3 — Open Frontier Intelligence · 2.8T parameters · 1M-token context"/>
  </a>
</p>

> **Want to join as an Open Source Friend?** These are the companies that back open source and help keep Nerve moving — and we say publicly where every token they give us goes. Reach out: [diegosouza.pw@outlook.com](mailto:diegosouza.pw@outlook.com)
...
<table>
  <tr>
    ...
    <td>
      ...
      <br/><br/>
      <b>What Kimi's support powers:</b> Kimi's API credits power Nerve's AI-validated release pipeline — the <i>merge validation powered by Kimi K3</i> stage that reviews every pull request before it ships — plus day-to-day feature development. First-class Kimi support ships on both rails: the direct <a href="https://platform.kimi.ai?aff=nerve">Kimi API</a> (<code>kimi-k3</code>) and the <a href="https://www.kimi.com/code?aff=nerve">Kimi Code coding plan</a> (OAuth and API key). Nerve is also the first Brazilian open-source project in Kimi's support program. <a href="https://platform.kimi.ai?aff=nerve"><b>Get a Kimi API key →</b></a>
    </td>
  </tr>
  <tr>
    <td align="center" width="150">
...
> A **combo** is a chain of models Nerve routes across **automatically**. Quota runs out, a provider fails, or costs spike — the combo silently slides to the next model. **This is what makes Nerve unbreakable.** 🛡️

### ⚡ Zero-config — just use `auto`

No combo to create. Set your model to `auto` (or a variant) and Nerve builds a virtual combo from your connected providers, scored live:
...
<img src="./docs/diagrams/resilience-layers.svg" width="100%" alt="Nerve resilience — 3 independent self-healing layers, the right layer for the right failure. Layer 1 provider circuit breaker (whole provider): trips only on 408/5xx, thresholds OAuth 3× / API-key 5× / local 2×, resets 60s/30s/15s into a HALF-OPEN probe, lazy recovery; while OPEN the combo reroutes to the next provider. Layer 2 connection cooldown (one key/account): base 5s OAuth / 3s API-key, exponential ×2 backoff with anti-thundering-herd guard, 429 honors Retry-After, success clears all error state; one cooling key is skipped while sibling keys keep serving. Layer 3 model lockout (one model): per-model 429, local 404 or mode denials lock just that model — never the whole connection. Terminal states (banned, expired, credits exhausted) are for the operator, not cooldowns."/>
...
Nerve is MIT-licensed and maintained in the open. If it saves you time or money, here's how to keep it independent — pick whatever fits you. Sponsorship never affects routing priority; it buys visibility, not ranking.

<table>
  <tr><td nowrap>⭐ <b>Star the repo</b></td><td>Free — genuinely helps visibility</td><td><a href="https://github.com/diegosouzapw/Nerve">Star Nerve</a></td></tr>
  ...
  <tr><td nowrap>🏢 <b>Open Collective</b></td><td><b>Companies</b> — issues an invoice/receipt · transparent books</td><td><a href="https://opencollective.com/nerve">opencollective.com/nerve</a></td></tr>
...
<img src="docs/assets/pix-qr.png" width="140" align="right" alt="Nerve PIX QR code"/>
...
```
00020101021126580014br.gov.bcb.pix01365d865059-bc44-483a-962d-43ceb80126eb5204000053039865802BR5922NERVE CONTRIBUICAO6006BRASIL62070503***630475DD
```
...
- **🤖 One-command CLI/agent setup** — `setup-*` configures 12+ coding tools; `nerve launch` / `launch-codex` are zero-config. → [CLI Integrations](docs/guides/CLI-INTEGRATIONS.md)
- **🛰️ Remote mode** — drive a remote Nerve with scoped tokens (`connect` / `contexts` / `tokens`) + an `antigravity` OAuth helper for VPS installs. → [Remote Mode](docs/guides/REMOTE-MODE.md)
...
- **💸 Cost telemetry everywhere** — `X-Nerve-*` cost/usage headers on every endpoint, cache-HIT savings header, per-key USD spend quotas. → [API Reference](docs/reference/API_REFERENCE.md)
- **🧠 Memory you control** — off by default, opt-in int8 vector quantization + typed decay, per-request `x-nerve-no-memory`. → [Memory](docs/frameworks/MEMORY.md)
...
- **📡 Routing transparency** — every response carries an `X-Nerve-Decision` header naming the strategy/provider/latency that served it, a new `cache-optimized` combo strategy + Auto-Combo `cacheAffinity` factor route repeat requests back to the connection holding the cached prefix, and a read-only `/v1/auto-combo/{channel}/candidates` endpoint exposes an `auto/*` channel's live candidate pool. → [Auto-Combo](docs/routing/AUTO-COMBO.md)
...
<sub>📖 Per-tool setup for all 33 tools (25 CLI Code's + 8 CLI Agents) → [`docs/reference/CLI-TOOLS.md`](docs/reference/CLI-TOOLS.md) · 🧩 OpenCode plugin → [`@nerve/opencode-provider`](https://www.npmjs.com/package/@nerve/opencode-provider)</sub>
...
<table>
  ...
  <tr><td align="left" nowrap>📦 <b>npm (global)</b></td><td align="left" nowrap><code>npm install -g nerve</code></td><td align="left">One command, any OS</td></tr>
  <tr><td align="left" nowrap>🐳 <b>Docker</b></td><td align="left" nowrap><code>docker run … diegosouzapw/nerve</code></td><td align="left">Multi-arch <b>AMD64 + ARM64</b></td></tr>
  ...
  <tr><td align="left" nowrap>📱 <b>Android (Termux)</b></td><td align="left" nowrap><code>pkg install nodejs && npx -y nerve</code></td><td align="left">Runs <b>on your phone</b>, 24/7, no root</td></tr>
  ...
  <tr><td align="left" nowrap>🧩 <b>OpenCode plugin</b></td><td align="left" nowrap><code>@nerve/opencode-provider</code></td><td align="left">Native OpenCode integration</td></tr>
...
> Beyond the server, Nerve is a **full command-line cockpit** with **80+ commands**, plus open agent protocols so an AI agent can drive it **on its own**.

### ⌨️ A real CLI (not just `start`)

```bash
nerve               # serve gateway + dashboard (port 20128)
nerve chat          # interactive TUI chat client (slash: /model /combo /skill /memory)
nerve setup         # guided first-run wizard
nerve doctor        # diagnose providers, ports, native deps
```

### 🛰️ Remote mode — run the CLI here, Nerve on a VPS

Nerve on a server? Drive it from your laptop with the **same CLI**. Log in once
with a scoped access token; every command then targets the remote.

```bash
nerve connect 192.168.0.15            # password → scoped token, saved as a context
nerve models list                     # ← runs against the REMOTE server
nerve configure codex                 # ← picks a remote model, writes a local Codex profile
nerve tokens create --name ci --scope read   # mint narrower tokens for other machines
nerve contexts use default            # ← switch back to the local server
```
...
<img src="./docs/diagrams/cli-terminal.svg" width="50%" alt="Animated terminal demoing the Nerve CLI — nerve providers list, nerve combo list, nerve health — cycling over the 80+ command surface: providers · oauth · keys · combo · nodes · models · cache · compression · cost · usage · quota · health · resilience · telemetry · logs · audit · mcp · a2a · cloud · memory · skills · eval · tunnel · backup · sync · webhooks · policy · pricing · translator · simulate …"/>

</div>

### 🤝 Connect an agent — and it controls Nerve itself

Expose Nerve over **MCP**, **A2A**, a **REST API**, **webhooks** or a **remote CLI** — any capable agent (or your own code) gets the keys to the whole gateway: routing, providers, combos, cache, compression, memory — autonomously. HTTP endpoints below are served under `http://localhost:20128`.

<table>
  <tr><th align="left">Interface</th><th align="left">Endpoint / command</th><th align="left">Use it for</th></tr>
  <tr><td align="left" nowrap>🧰 <b>MCP (stdio)</b></td><td align="left" nowrap><code>nerve --mcp</code></td><td align="left">Plug into Claude Desktop, Cursor, any MCP client</td></tr>
  ...
  <tr><td align="left" nowrap>🛰️ <b>Remote CLI</b></td><td align="left" nowrap><code>nerve connect <host></code></td><td align="left">Drive a remote instance with scoped access tokens</td></tr>
</table>

```bash
# Give Claude Code the full Nerve toolset over MCP:
claude mcp add-server nerve --type http --url http://localhost:20128/api/mcp/stream
```
...
<img src="./docs/diagrams/compression-pipeline.svg" width="100%" alt="Nerve compression pipeline: a client request of 10,000 tokens passes through 12 stacked engines — Session-Dedup, CCR, Lite, RTK, Responses Tool Output, Headroom, Relevance, Caveman, Aggressive, LLMLingua-2, Ultra, OmniGlyph — and reaches the provider at about 1,080 tokens, up to 95% saved. Code, URLs and JSON are always preserved byte-perfect."/>
...
> **Why use many tokens when few tokens do the trick?** Every request passes through Nerve's compression pipeline **transparently** — no client changes. It's now a **stack of 12 composable engines** that run in order and mix & match per routing combo — building on ideas from [RTK](https://github.com/rtk-ai/rtk), [Caveman](https://github.com/JuliusBrussee/caveman) (⭐ 90K+), [LLMLingua-2](https://github.com/microsoft/LLMLingua), and [Troglodita](https://github.com/leninejunior/troglodita) (PT-BR).
...
- **🎛️ Where compression is decided** _(precedence, high → low)_ — per-request `x-nerve-compression` header › routing-combo override › active named profile › adaptive / auto-trigger › panel default › off. The applied plan echoes back in the `X-Nerve-Compression: <mode>; source=<source>` response header.
...
You should see your connected models listed. 🎉 That's it — start coding, and Nerve auto-routes & falls back for you.

If your client cannot send custom headers, Nerve also exposes tokenized compatibility aliases:
...
```bash
docker run -d --name nerve --restart unless-stopped --stop-timeout 40 \
  -p 127.0.0.1:20128:20128 -v nerve-data:/app/data diegosouzapw/nerve:latest
```
...
```bash
pnpm add -g nerve@latest --allow-build=better-sqlite3 --allow-build=@swc/core && nerve
```

**🐧 Arch Linux (AUR)**

```bash
yay -S nerve-bin && systemctl --user enable --now nerve.service
```
...
```bash
NERVE_SKIP_POSTINSTALL=1 npm install -g nerve   # CI=1 also skips it
```
...
> 🎬 **Made a video about Nerve?** Open an [issue](https://github.com/diegosouzapw/Nerve/issues/new) or [discussion](https://github.com/diegosouzapw/Nerve/discussions) with the link — we'll feature it here.
...
<table>
  ...
  <tr><td nowrap><b>Links</b></td><td><a href="https://nerve.online">Website</a> · <a href="https://www.npmjs.com/package/nerve">npm</a> · <a href="https://hub.docker.com/r/diegosouzapw/nerve">Docker Hub</a></td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Remote Mode</a></b></td><td>Drive a remote Nerve (VPS) from your laptop CLI via scoped access tokens</td></tr>
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">Claude Code Config</a></b></td><td>Point Claude Code at Nerve (local/remote) with <code>launch</code> + per-model profiles</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/TERMUX_GUIDE.md">Termux Guide</a></b></td><td>Run Nerve on Android via Termux</td></tr>
...
> Nerve is shaped by a passionate open-source community. These individuals have made exceptional contributions that directly impact the quality, stability, and reach of the project. **Thank you.**
...
> 🙏 These contributors' features, bug fixes, and infrastructure improvements are a **core part** of what makes Nerve reliable and feature-rich. Every pull request, every test case, and every i18n translation file matters. Open source is built by people like them.
...
A heartfelt thank-you to the people who fund Nerve out of their own pocket — every contribution keeps the project free, independent and moving.
...
<b><a href="https://github.com/sponsors/diegosouzapw">💖 Become a sponsor →</a></b> — every dollar keeps Nerve free and independent.
...
[![Contributors](https://contrib.rocks/image?repo=diegosouzapw/Nerve&max=400&columns=20&anon=1)](https://github.com/diegosouzapw/Nerve/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=diegosouzapw%2FNerve&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/Nerve&type=date&theme=dark&legend=top-left&sealed_token=XP_ycEjv7s31p1edvhsMOXry51OWYsUjDRWjflSG7jQKRpO9hPGg7i_EHvwhI6QtrARTMH-YGjJhi8sumRYflEJD0DPlH_MMHjizhBYCX8fbHFrHEiNvVA" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/Nerve&type=date&legend=top-left&sealed_token=XP_ycEjv7s31p1edvhsMOXry51OWYsUjDRWjflSG7jQKRpO9hPGg7i_EHvwhI6QtrARTMH-YGjJhi8sumRYflEJD0DPlH_MMHjizhBYCX8fbHFrHEiNvVA" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=diegosouzapw/Nerve&type=date&legend=top-left&sealed_token=XP_ycEjv7s31p1edvhsMOXry51OWYsUjDRWjflSG7jQKRpO9hPGg7i_EHvwhI6QtrARTMH-YGjJhi8sumRYflEJD0DPlH_MMHjizhBYCX8fbHFrHEiNvVA" />
 </picture>
</a>
...
<a href="https://starmapper.bruniaux.com/diegosouzapw/nerve">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/nerve?theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/nerve?theme=light" />
    <img alt="StarMapper" src="https://starmapper.bruniaux.com/api/map-image/diegosouzapw/nerve" />
  </picture>
</a>
</div>
...
<table>
  <tr><th align="left">Project</th><th align="center">⭐</th><th align="left">How it inspired Nerve</th></tr>
...
**[⬆ Back to top](#-nerve)** · Built with ❤️ for the open-source AI community.

<sub>Nerve v3.8.49 · Node ≥22.22.2 · MIT License · <a href="https://nerve.online">nerve.online</a></sub>
