 ...
 *     is set explicitly. The Nerve LOCAL_ONLY rule is enforced at the
...
declare global {
  var __nerveEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__nerveEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__nerveEmbedWsStarted = true;
