...
function getRegistryState() {
  if (!globalThis.__nervePreRequestRegistry) {
    globalThis.__nervePreRequestRegistry = {
      initialized: false,
      hooks: new Map(),
      middlewares: new Map(),
      logs: [],
  ...
  return globalThis.__nervePreRequestRegistry;
}
