...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'nerve'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with Nerve
...
-- Determines whether each provider uses Nerve's native executor,
