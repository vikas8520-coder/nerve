...
import { NERVE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@nerve/open-sse/services/webSearchFallback.ts";
import { NERVE_WEB_FETCH_FALLBACK_TOOL_NAME } from "@nerve/open-sse/services/webFetchInterception.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [NERVE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
  [NERVE_WEB_FETCH_FALLBACK_TOOL_NAME]: "web_fetch",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the Nerve-handled tool_use blocks, and expose
