...
/**
 * Maps Arena leaderboard categories to Nerve task-type categories.
 *
...
/**
 * Nerve model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name Nerve uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to Nerve task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known Nerve model aliases are also expanded into additional entries.
 *
