...
export default function RequestLoggerDetail({
  ...
  const cacheSourceLabel = cacheSource === "semantic" ? "Semantic (Nerve)" : "Upstream (Provider)";
            ...
            <div className="flex flex-col">
              ...
              {hasStatusDiscrepancy && (
                <span className="text-[10px] text-amber-600 dark:text-amber-400 font-medium mt-0.5">
                  Nerve returned {log.status} even though provider returned {providerStatus}
                </span>
              )}
            </div>
