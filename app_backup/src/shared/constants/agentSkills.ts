...
export const CURATED_SKILLS: CuratedSkillEntry[] = [
  ...
  },
  {
    ...
    name: "API Keys",
    description:
      "Create, list, rotate, and revoke Nerve API keys. Control per-key scopes, spending limits, and expiration. Keys gate access to all proxy and management endpoints.",
    category: "api",
    area: "api-keys",
    icon: "vpn_key",
  },
  ...
  },
  {
    ...
    name: "CLI Tools",
    description:
      "Manage CLI tool integrations exposed via the API. List, configure, and invoke CLI tool plugins that extend Nerve's automation surface.",
    category: "api",
    area: "cli-tools",
    icon: "terminal",
  },
  {
    ...
    name: "Tunnels",
    description:
      "Create and manage secure tunnels (ngrok, Cloudflare Tunnel, custom) to expose Nerve to the internet or share access with remote agents and CI pipelines.",
    category: "api",
    area: "tunnels",
    icon: "vpn_lock",
  },
  {
    ...
    name: "Cloud Sync",
    description:
      "Synchronise Nerve configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.",
    category: "api",
    area: "sync-cloud",
    icon: "cloud_sync",
  },
  ...
  },
  {
    ...
    name: "CLI: Chat",
    description:
      "Send chat completions, stream responses, and start an interactive REPL session from the CLI. Supports all Nerve providers, combo routing, and system prompt configuration.",
    category: "cli",
    area: "cli-chat",
    icon: "chat",
  },
  ...
  },
  {
    ...
    description:
      "Detect installed CLI coding tools (Claude Code, Codex, Cursor, Copilot, Cline and more), search GitHub for matching agent skills, and install them to the detected tools via Nerve's built-in APIs.",
    category: "cli",
    area: "cli-setup",
    icon: "extension",
  },
...

  {
    ...
    description:
      "Step-by-step agent workflow to configure the OpenAI Codex CLI on any machine (Linux, macOS, Windows) to use Nerve as an OpenAI-compatible backend. Detects OS and shell, writes config.toml and 7 named profiles, sets environment variables, and verifies the setup.",
    category: "config",
