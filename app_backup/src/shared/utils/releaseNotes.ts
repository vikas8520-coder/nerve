...
export const NEWS_JSON_URL = "https://raw.githubusercontent.com/diegosouzapw/Nerve/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/diegosouzapw/Nerve/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL = "https://github.com/diegosouzapw/Nerve/blob/main/CHANGELOG.md";
