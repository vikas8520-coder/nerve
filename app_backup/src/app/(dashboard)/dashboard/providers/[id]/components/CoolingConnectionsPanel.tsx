 ...
 * indicator the user has no way to see "Nerve learned that this key is
  ...
  return (
    ...
    >
      ...
      <p className="mb-3 text-xs text-muted-foreground">
        These connections returned a 429 (rate-limit) on their last request. Nerve will skip them
        until the timer expires — no manual disable required.
      </p>
