...
const CODEX_KEY = "NERVE_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "NERVE_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the NERVE_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
