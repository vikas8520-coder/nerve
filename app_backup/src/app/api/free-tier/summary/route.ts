import { computeFreeModelTotals } from "@nerve/open-sse/config/freeModelCatalog.ts";
import { FREE_CATALOG_CURATED_AT } from "@nerve/open-sse/config/freeModelCatalog.data.ts";
