...
import { initTranslators } from "@nerve/open-sse/translator/index.ts";
...
} from "@nerve/open-sse/utils/earlyStreamKeepalive";
import { resolveKeepaliveThreshold } from "@nerve/open-sse/utils/keepaliveThreshold";
import {
  admitChatRequest,
  admitChatStructure,
...
export async function POST(request) {
  ...
  try {
    ...
    // typical chat payloads. Toggle off via NERVE_LOG_REQUEST_SHAPE=0.
    if (process.env.NERVE_LOG_REQUEST_SHAPE !== "0") {
