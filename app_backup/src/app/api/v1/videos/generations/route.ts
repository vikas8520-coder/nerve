import { handleVideoGeneration } from "@nerve/open-sse/handlers/videoGeneration.ts";
import { resolveVideoCredentialProvider } from "@nerve/open-sse/handlers/videoGeneration/googleFlow.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { parseVideoModel, getVideoProvider } from "@nerve/open-sse/config/videoRegistry.ts";
