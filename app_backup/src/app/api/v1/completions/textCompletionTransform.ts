/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. Nerve routes
 ...
 * the model they asked for, and the `x-nerve-model` response header
 ...
 * requested identifier (matching the `x-nerve-model` response header).
 */
