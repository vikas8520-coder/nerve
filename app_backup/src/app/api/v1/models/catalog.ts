...
import { getAllEmbeddingModels } from "@nerve/open-sse/config/embeddingRegistry";
import { getAllImageModels, isRegisteredImageModel } from "@nerve/open-sse/config/imageRegistry";
import { getAllRerankModels } from "@nerve/open-sse/config/rerankRegistry";
import { getAllAudioModels } from "@nerve/open-sse/config/audioRegistry";
import { getAllModerationModels } from "@nerve/open-sse/config/moderationRegistry";
import { getAllVideoModels } from "@nerve/open-sse/config/videoRegistry";
import { getAllMusicModels } from "@nerve/open-sse/config/musicRegistry";
import { REGISTRY } from "@nerve/open-sse/config/providerRegistry";
import { CODEX_NATIVE_UNPREFIXED_MODELS } from "@nerve/open-sse/services/model";
import { resolveNestedComboTargets } from "@nerve/open-sse/services/combo";
import {
  ...
  isPaidTierAutoId,
} from "@nerve/open-sse/services/autoCombo/builtinCatalog";
...
import { getTokenLimit } from "@nerve/open-sse/services/contextManager";
  ...
  try {
    ...
    if (apiKey) {
      ...
      if (keyMeta && keyMeta.allowedQuotas && keyMeta.allowedQuotas.length > 0) {
        ...
        // (NERVE_API_KEY / ROUTER_API_KEY per isValidApiKey). Those keys have no
