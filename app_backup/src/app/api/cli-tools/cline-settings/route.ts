...
// Check if Nerve is configured as OpenAI-compatible provider
const hasNerveConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasNerve: hasNerveConfig(globalState),
...
// POST - Configure Cline to use Nerve as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_nerve";
...
// DELETE - Remove Nerve OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Nerve settings removed from Cline",
    });
  } catch (error) {
