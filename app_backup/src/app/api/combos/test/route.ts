...
import { resolveNestedComboTargets } from "@nerve/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // Nerve's semantic cache or other request reuse layers.
          "X-Nerve-No-Cache": "true",
          ...(target.connectionId ? { "X-Nerve-Connection": target.connectionId } : {}),
