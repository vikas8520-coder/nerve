/**
 * Nerve Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "nerve-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "nerve-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__nerveMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    dragRegion.className = "nerve-electron-drag-region";
