 ...
 *
 * Scope (minimal): only models that Nerve already references throughout
 ...
 * provider registry. We do NOT restore models Nerve deliberately curated
 * out (e.g. o1, gpt-4-turbo) nor re-add embedding/TTS/image entries that
 * Nerve deliberately keeps in their own typed registries
