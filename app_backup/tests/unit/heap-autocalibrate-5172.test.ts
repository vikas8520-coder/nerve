 ...
 * spawned with a FIXED 512MB heap default (`nerve serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `NERVE_MEMORY_MB` still wins
...
test("#5172 an explicit NERVE_MEMORY_MB still wins over the calibrated default", () => {
