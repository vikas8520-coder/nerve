...
import { detectCompressionLanguage } from "@nerve/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@nerve/open-sse/services/compression/caveman.ts";
