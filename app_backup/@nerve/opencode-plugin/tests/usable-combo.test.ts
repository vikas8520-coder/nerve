 ...
 * `providerId` field — Nerve's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type NerveRawCombo } from "../src/index.js";
...
function combo(models: NerveRawCombo["models"]): NerveRawCombo {
