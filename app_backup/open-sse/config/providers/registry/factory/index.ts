...
// local `droid` CLI. Nerve already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through Nerve.
//
...
// back to stored CLI credentials only when omitted. Nerve does NOT read
