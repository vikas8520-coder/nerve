 ...
 *
 * Nerve → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only Nerve-style backwards-compat aliases where users
...
// Nerve uses dot-notation user IDs (e.g. "gpt-5.5-high").
