...
function sanitizeAntigravityGeminiRequest(
  ...
  // Missing settings stay absent so Nerve does not silently weaken upstream safety.
...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set NERVER_ALLOW_BODY_PROJECT_OVERRIDE=1.
    ...
    const allowBodyProjectOverride = process.env.NERVE_ALLOW_BODY_PROJECT_OVERRIDE === "1";
    ...
    // Opt-in escape hatch: set NERVE_ALLOW_BODY_PROJECT_OVERRIDE=1.
    let projectId =
