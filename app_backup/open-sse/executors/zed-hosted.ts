 ...
 * to OpenAI Chat Completions chunks by reusing Nerve's own translators
 ...
 * adapted to TypeScript + Nerve's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      clientHeaders?.[THINKING_MARKER_HEADER] ?? clientHeaders?.["x-nerve-thinking-marker"] ?? null,
