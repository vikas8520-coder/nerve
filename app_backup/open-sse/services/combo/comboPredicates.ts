...
// #1731v2 guard: a provider circuit-breaker-open response (503 + `X-Nerve-Provider-Breaker`
// header / `provider_circuit_open` error code, see providerCircuitOpenResponse) is an Nerve
...
export function isProviderCircuitOpenResult(
  ...
  const breakerHeader = result.headers?.get?.("x-nerve-provider-breaker");
