...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-Nerve-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-Nerve-Budget value in USD (#6023). */
    budgetCap?: number | null;
    /** Per-request X-Nerve-Budget-Fallback value ("cheapest" | "strict") — #3470. */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025 / #3470): X-Nerve-Budget,
  // X-Nerve-Budget-Fallback and X-Nerve-Mode headers (threaded via
  ...
  // per-request X-Nerve-Mode override — but `scoreAutoTargets()` (the fallback
