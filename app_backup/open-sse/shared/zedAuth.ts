 ...
 *
 *   1. The client (Nerve) generates an ephemeral RSA keypair.
 ...
 *   5. Nerve decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + Nerve conventions. `fetch` is intentionally the
