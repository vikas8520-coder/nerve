...
import { buildNerveSseMetadataComment } from "@/domain/nerveResponseMeta";
import {
...
export const PENDING_REQUEST_CLEARED_MARKER = "__nervePendingRequestCleared";
            ...
            if (trimmed.startsWith("data:") && trimmed.slice(5).trim() !== "[DONE]") {
              try {
                ...
                if (isResponsesSSE) {
                  ...
                  // chunk like "[Nerve] Upstream returned an empty response. Please
