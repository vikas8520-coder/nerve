...
const nextConfig = {
  env: { NEXT_PUBLIC_NERVE_BASE_PATH: "" },
  ...
  outputFileTracingRoot: "/Users/vikasreddy/Projects/nerve",
  ...
  experimental: {
    ...
    lockDistDir: true,
    proxyClientMaxBodySize: 536870912,
  ...
  turbopack: {
    root: "/Users/vikasreddy/Projects/nerve",
    resolveAlias: { "next-intl/config": "./src/i18n/request.ts" },
    ignoreIssue: [
      { path: "**/src/lib/agentSkills/**", description: {} },
      { path: "**/open-sse/services/compression/**", description: {} },
    ],
    rules: {
      "**/*.js": {
        condition: { content: {} },
        loaders: [
          {
            ...
            options: {
              type: "turbopack",
              configPath: "/Users/vikasreddy/Projects/nerve/source.config.ts",
              outDir: "/Users/vikasreddy/Projects/nerve/.source",
              compiledConfigPath: "/Users/vikasreddy/Projects/nerve/.source/source.config.mjs",
              isDev: false,
              macro: true,
            },
          },
  ...
  _originalRewrites: {
    ...
    afterFiles: [
      ...
      { source: "/openai/:path*", destination: "/api/openai/:path*" },
      { source: "/metrics", destination: "/api/metrics" },
      { source: "/debug", destination: "/api/debug" },
      { source: "/.env", destination: "/api/.env" },
    ],
    fallback: [],
  },
  _originalRedirects: [
    { source: "/dashboard/skills", destination: "/dashboard/omni-skills", permanent: true },
    {
      source: "/docs/architecture",
      destination: "/docs/architecture/architecture",
      permanent: true,
    },
    { source: "/docs/authz-guide", destination: "/docs/architecture/authz-guide", permanent: true },
    {
    ...
    { source: "/docs/electron-guide", destination: "/docs/guides/electron-guide", permanent: true },
    ...
    { source: "/docs/gamification", destination: "/docs/frameworks/gamification", permanent: true },
    ...
    { source: "/docs/stealth-guide", destination: "/docs/security/stealth-guide", permanent: true },
    {
