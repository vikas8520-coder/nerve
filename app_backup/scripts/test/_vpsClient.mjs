 ...
 *
 * Reusable Phase-3 VPS HTTP client for Nerve combo live-smoke tests.
 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.nerve/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.nerve/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== Nerve VPS Phase-3 Preflight ===");
