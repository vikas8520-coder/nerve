...
/**
 * Writes BUILD_NERVE_BASE_PATH into the standalone bundle so container start
 * can compare the baked Next.js basePath against NERVE_BASE_PATH.
 */
...
function writeSentinel(targetDir) {
  const basePath = normalizeBasePath(process.env.NERVE_BASE_PATH);
  const sentinel = path.join(targetDir, "BUILD_NERVE_BASE_PATH");
