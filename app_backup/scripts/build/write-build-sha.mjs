...
/**
 * write-build-sha.mjs — HEAD sentinel guard for Nerve release builds.
 *
 * Writes NERVE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.NERVE_BUILD_SHA) {
    return process.env.NERVE_BUILD_SHA.trim();
  }
  try {
