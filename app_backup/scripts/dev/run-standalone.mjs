...
// #2939: honor NERVE_MEMORY_MB (default 512), the same knob
// `nerve serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.NERVE_MEMORY_MB);
