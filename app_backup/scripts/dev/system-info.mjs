#!/usr/bin/env node
/**
 * system-info.mjs — Nerve System Information Reporter (#280)
 *
...
lines.push("Nerve System Information Report");
...
const installedGlobal = run("npm list -g nerve --depth=0 2>/dev/null | grep nerve");
lines.push(`Global npm: ${installedGlobal || "not installed globally"}`);

const pm2Status = run("pm2 list 2>/dev/null | grep nerve | awk '{print $4, $10, $12}'");
...
console.log(
  `📎 Attach this file when reporting issues at: https://github.com/diegosouzapw/Nerve/issues`
);
