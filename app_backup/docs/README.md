...
Navigable index of the Nerve documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using Nerve — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run Nerve in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let Nerve pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of Nerve.
...
- [TIERS.md](guides/TIERS.md) — Nerve tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running Nerve under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing Nerve remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with Nerve.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with Nerve.
...
- [NERVE_VS_ALTERNATIVES.md](comparison/NERVE_VS_ALTERNATIVES.md) — how Nerve compares to alternatives.
