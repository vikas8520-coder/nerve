---
title: "Nerve Agent Skills Catalog"
version: 3.8.40
...
- A **GitHub raw URL** for live fetch: `https://raw.githubusercontent.com/diegosouzapw/Nerve/refs/heads/main/skills/{id}/SKILL.md`
...
- [MCP-SERVER.md](./MCP-SERVER.md) — MCP tool catalog (`nerve_agent_skills_*` tools)
