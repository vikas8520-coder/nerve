---
title: "🗜️ Prompt Compression Guide — Nerve"
version: 3.8.40
lastUpdated: 2026-06-28
---

# 🗜️ Prompt Compression Guide — Nerve
...
Nerve implements a modular prompt compression pipeline that runs **proactively** before requests hit upstream providers. This means your token savings happen transparently — no changes needed to your workflow.
...
Nerve documents compression savings from two sources: upstream project benchmarks and
Nerve's own engine composition.
...
For overlapping tool/context payloads, the default Nerve combo stacks the engines:
...
Send the `x-nerve-compression` request header to override the compression plan for a single
...
The applied plan is echoed back in the `X-Nerve-Compression: <mode>; source=<source>` response
...
Beyond the 7 standard modes, Nerve includes several advanced compression
