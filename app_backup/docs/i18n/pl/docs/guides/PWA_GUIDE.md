...
Nerve jest dostarczany jako w pełni instalowalna Progressive Web App. Gdy otworzysz dashboard w dowolnej przeglądarce mobilnej — Android (Chrome) lub iOS (Safari) — możesz wybrać „Dodaj do ekranu głównego” i uzyskać doświadczenie zbliżone do natywnej aplikacji, bez sklepu z aplikacjami.

## Czym jest PWA?

Progressive Web App zamienia webowy dashboard Nerve w coś, co wygląda i działa jak natywna aplikacja mobilna. Po zainstalowaniu:
...
1. Otwórz dashboard Nerve w Chrome: `http://YOUR_IP:20128`
2. Chrome automatycznie pokaże baner **"Add Nerve to Home screen"**, albo:
   - Stuknij menu **⋮** (trzy kropki) → **"Add to Home screen"** lub **"Install app"**
3. Potwierdź monity
4. Nerve pojawi się na ekranie głównym jako samodzielna aplikacja

### iOS (Safari)

1. Otwórz dashboard Nerve w Safari: `http://YOUR_IP:20128`
2. Stuknij przycisk **Share** (kwadrat ze strzałką)
3. Przewiń w dół i stuknij **"Add to Home Screen"**
4. Nadaj nazwę (domyślnie „Nerve”) i stuknij **Add**
5. Nerve pojawi się na ekranie głównym z ikoną aplikacji

### Desktop (Chrome / Edge)

1. Otwórz dashboard Nerve
2. Kliknij **ikona instalacji** na pasku adresu (lub ⋮ → "Install Nerve...")
3. Potwierdź monity
4. Nerve otworzy się jako samodzielne okno — bez kart i paska adresu
...
Nerve zawiera service worker (`sw.js`), który zapewnia inteligentne buforowanie:
...
Nerve dostarcza ikony zoptymalizowane pod każdą platformę:
...
```json
{
  "name": "Nerve",
  "short_name": "Nerve",
  "description": "Nerve is an AI gateway for multi-provider LLMs. One endpoint for all your AI providers.",
  "start_url": "/",
  "scope": "/",
  "display": "fullscreen",
  "orientation": "any",
...
- **Wersjonowanie cache**: `nerve-pwa-v2` — zwiększ tę wartość, aby wymusić świeży cache przy aktualizacji
...
Przy uruchamianiu Nerve na Androidzie przez Termux PWA działa bezproblemowo:

1. Uruchom Nerve w Termux: `npx nerve`
...
Zainstaluj PWA na dowolnym urządzeniu, które ma dostęp przeglądarkowy do serwera Nerve:
