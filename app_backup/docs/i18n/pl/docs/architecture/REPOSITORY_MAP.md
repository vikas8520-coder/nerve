...
> Ostatnia aktualizacja: 2026-06-28 — Nerve v3.8.40
>
...
├── @nerve/           # Publikowalne pakiety towarzyszące (opencode-plugin, opencode-provider)
├── skills/               # Paczki skilli CLI/agent (cli-* + omni-* + config-codex-cli)
├── examples/             # Przykładowe pluginy + starter nerve-cmd-hello
...
Osobny workspace npm (`@nerve/open-sse`). Obsługuje przetwarzanie żądań + wykonanie u providerów.
...
| `preload.js`     | Most IPC (contextBridge → `window.nerve`)                                       |
...
| Plik                                                                                                        | Cel                                                                                                                           |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `nerve.mjs`                                                                                             | Główne wejście CLI — `nerve serve`, `nerve setup`, `nerve doctor`, `nerve providers`, `nerve combos` itd. |
...
| Plik                         | Cel                                                                                       |
| ---------------------------- | ----------------------------------------------------------------------------------------- |
| `skills/nerve*/SKILL.md` | 10 manifestów skilli dla zewnętrznych agentów AI (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | Integracje zewnętrznych CLI + wewnętrzne CLI Nerve                               |
...
- **`_mono_repo/`** — historyczne podprojekty (nerveCloud, nerveSite, vscode-extension)
