...
Nawigowalny indeks zestawu dokumentacji Nerve. Tematy są pogrupowane według celu, abyś szybko znalazł to, czego potrzebujesz.
...
Proste przewodniki po korzystaniu z Nerve — bez wymaganej wiedzy technicznej.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — zainstaluj i uruchom Nerve w 3 minuty.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — pozwól Nerve wybrać dla Ciebie najlepsze AI.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — pierwsza konfiguracja Nerve.
...
- [TIERS.md](guides/TIERS.md) — poziomy Nerve wyjaśnione (przewodnik użytkownika).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — uruchamianie Nerve w Dockerze.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — udostępnianie Nerve zdalnie + tokeny z zakresem (scoped tokens).
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — główna tabela integracji CLI `setup-*`.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI z Nerve.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI z Nerve.
...
- [NERVE_VS_ALTERNATIVES.md](comparison/NERVE_VS_ALTERNATIVES.md) — jak Nerve wypada na tle alternatyw.
