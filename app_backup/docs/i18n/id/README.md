# 🚀 Nerve — Gateway AI Gratis (Bahasa Indonesia)
...
![NPM Downloads](https://img.shields.io/npm/dw/nerve?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/nerve?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/nerve?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/nerve)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/diegosouzapw/nerve/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/diegosouzapw/Nerve?logo=star&style=flat)](https://github.com/diegosouzapw/Nerve/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/diegosouzapw/Nerve?logo=issue)](https://github.com/diegosouzapw/Nerve/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/diegosouzapw/Nerve?logo=law)](https://github.com/diegosouzapw/Nerve/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/diegosouzapw/Nerve?logo=history&logoColor=white)](https://github.com/diegosouzapw/Nerve/commits/main)
...
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/diegosouzapw/Nerve?logo=file-code&logoColor=white)](https://github.com/diegosouzapw/Nerve)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/diegosouzapw/Nerve?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/diegosouzapw/Nerve/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/diegosouzapw/Nerve?logo=tag&logoColor=white)](https://github.com/diegosouzapw/Nerve/tags)
...
[![fork](https://custom-icon-badges.demolab.com/github/forks/diegosouzapw/Nerve?logo=fork)](https://github.com/diegosouzapw/Nerve/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/diegosouzapw/Nerve?logo=eye)](https://github.com/diegosouzapw/Nerve/watchers)

[![License](https://img.shields.io/github/license/diegosouzapw/Nerve)](https://github.com/diegosouzapw/Nerve/blob/main/LICENSE)
...
[🌐 Website](https://nerve.online) • [🚀 Mulai Cepat](#-quick-start) • [💡 Fitur](#-key-features) • [📖 Dokumentasi](#-documentation) • [💰 Harga](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainNerve.png" alt="Nerve Dashboard" width="800"/>
</div>
...
_Hubungkan IDE atau alat CLI berbasis AI apa pun melalui Nerve — gateway API gratis untuk coding tanpa batas._
...
<sub>📡 Semua agen terhubung melalui <code>http://localhost:20128/v1</code> atau <code>http://cloud.nerve.online/v1</code> — satu konfigurasi, model dan kuota tak terbatas</sub>
...
- **Issues**: [github.com/diegosouzapw/Nerve/issues](https://github.com/diegosouzapw/Nerve/issues)
...
## 🎯 Apa yang Diselesaikan Nerve — 30 Masalah Nyata & Kasus Penggunaan

> **Setiap developer yang menggunakan alat AI menghadapi masalah ini setiap hari.** Nerve dibangun untuk menyelesaikannya semua — dari pembengkakan biaya hingga pemblokiran regional, dari alur OAuth yang rusak hingga operasi protokol dan observabilitas enterprise.
...
**Bagaimana Nerve menyelesaikannya:**
...
- **Laporan Info Sistem** — `npm run system-info` menghasilkan `system-info.txt` dengan lingkungan lengkap Anda (versi Node, versi Nerve, OS, alat CLI, status Docker/PM2). Lampirkan saat melaporkan masalah untuk triase instan.
...
- **instal global npm** — `npm install -g nerve && nerve` — selesai
...
- Mulai cepat bawaan untuk `nerve --mcp` dan orientasi klien
...
```txt
1) Start MCP transport (`nerve --mcp`) for tool-driven operations
...
>
> ```bash
> pnpm add -g nerve@latest --allow-build=better-sqlite3 --allow-build=@swc/core
> nerve
> ```
...
Pengguna Arch Linux dapat menginstal [AUR package](https://aur.archlinux.org/packages/nerve-bin), yang menginstal Nerve dan menyediakan layanan pengguna systemd:
...
| Command             | Description                                                     |
| ------------------- | --------------------------------------------------------------- |
| `nerve`             | Mulai server (`PORT=20128`, API dan dasbor pada port yang sama) |
| `nerve --port 3000` | Set canonical/API port to 3000                                  |
| `nerve --mcp`       | Mulai server MCP (stdio transport)                              |
| `nerve --no-open`   | Don't auto-open browser                                         |
| `nerve --help`      | Show help                                                       |

Optional split-port mode:

```bash
PORT=20128 DASHBOARD_PORT=20129 nerve
...
Saat Anda tidak lagi memerlukan Nerve, kami menyediakan dua skrip cepat untuk penghapusan bersih:

| Command                  | Action                                                                                       |
| ------------------------ | -------------------------------------------------------------------------------------------- |
| `npm run uninstall`      | Menghapus aplikasi sistem tetapi **menyimpan DB dan konfigurasi Anda** di `~/.nerve`.        |
| `npm run uninstall:full` | Menghapus aplikasi DAN secara permanen **menghapus semua konfigurasi, kunci, dan database**. |

> Catatan: Untuk menjalankan perintah ini, navigasikan ke folder proyek Nerve (jika Anda mengkloningnya) dan jalankan. Alternatifnya, jika diinstal secara global, Anda cukup menjalankan `npm uninstall -g nerve`.
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Kesenjangan maksimum antara potongan streaming sebelum Nerve membatalkan aliran SSE                                                                                          |
...
Untuk upstream yang kompatibel dengan Kode Claude (`anthropic-compatible-cc-*`), Nerve juga memperoleh header `X-Stainless-Timeout` keluar dari batas waktu pengambilan yang diselesaikan sehingga batas waktu baca sisi penyedia tetap selaras dengan konfigurasi env Anda.

Untuk reverse proxy pihak ketiga yang kompatibel dengan Claude Code, Nerve tetap menggunakan default
...
`cache_control`, Nerve tidak memasukkan penanda milik jembatan.
...
Untuk permintaan streaming, `FETCH_TIMEOUT_MS` hanya mencakup pengaturan koneksi/menunggu respons upstream pertama. Setelah aliran aktif, Nerve hanya akan dibatalkan pada keadaan terhenti sebenarnya (`STREAM_IDLE_TIMEOUT_MS`) atau tubuh Undici tidak aktif (`FETCH_BODY_TIMEOUT_MS`).

Jika Anda menjalankan Nerve di belakang Nginx, Caddy, Cloudflare, atau proksi terbalik lainnya, pastikan proksi tersebut
waktu tunggu juga lebih tinggi daripada waktu tunggu aliran/pengambilan Nerve Anda.
...
### 3) Arahkan alat pengkodean Anda ke Nerve
...
Untuk pengguna Void Linux, Anda dapat membuat paket asli menggunakan `xbps-src`. Simpan blok ini sebagai `srcpkgs/nerve/template`:

```bash
# Template file for 'nerve'
pkgname=nerve
version=3.4.1
revision=1
...
license="MIT"
homepage="https://github.com/diegosouzapw/Nerve"
distfiles="https://github.com/diegosouzapw/Nerve/archive/refs/tags/v${version}.tar.gz"
checksum=009400afee90a9f32599d8fe734145cfd84098140b7287990183dde45ae2245b
system_accounts="_nerve"
nerve_homedir="/var/lib/nerve"
...
do_install() {
	vmkdir usr/lib/nerve/.next

	vcopy .next/standalone/. usr/lib/nerve/.next/standalone
	...
	for _d in \
		...
		touch "${DESTDIR}/usr/lib/nerve/${_d}/.keep"
	done

	cat > "${WRKDIR}/nerve" <<'EOF'
#!/bin/sh
export PORT="${PORT:-20128}"
export DATA_DIR="${DATA_DIR:-${XDG_DATA_HOME:-${HOME}/.local/share}/nerve}"
export APP_LOG_TO_FILE="${APP_LOG_TO_FILE:-false}"
mkdir -p "${DATA_DIR}"
exec node /usr/lib/nerve/.next/standalone/server.js "$@"
EOF
	vbin "${WRKDIR}/nerve"
}
...
Nerve tersedia sebagai image Docker publik di [Docker Hub](https://hub.docker.com/r/diegosouzapw/nerve).
...
docker run -d \
  ...
  --stop-timeout 40 \
  -p 20128:20128 \
  -v nerve-data:/app/data \
  diegosouzapw/nerve:latest
```
...
- Terowongan Cepat tidak dipulihkan secara otomatis setelah Nerve atau kontainer dimulai ulang. Aktifkan kembali dari dasbor bila diperlukan.
...
- SQLite berjalan dalam mode WAL. `docker stop` harus dibiarkan selesai sehingga Nerve dapat memeriksa kembali perubahan terbaru ke `storage.sqlite`.
...
- Setel `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` jika Anda ingin Nerve menggunakan biner yang sudah ada alih-alih mengunduhnya.

**Menggunakan Docker Compose dengan Caddy (HTTPS Auto-TLS):**

Nerve dapat diekspos dengan aman menggunakan penyediaan SSL otomatis Caddy. Pastikan data DNS A domain Anda mengarah ke IP server Anda.

```yaml
services:
  nerve:
    image: diegosouzapw/nerve:latest
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://nerve:20128
...
| -------------------- | -------- | ------ | --------------------- |
| `diegosouzapw/nerve` | `latest` | ~250MB | Latest stable release |
| `diegosouzapw/nerve` | `3.6.2`  | ~250MB | Current version       |

---

## 🖥️ Aplikasi Desktop — Offline & Selalu Aktif

> 🆕 **BARU!** Nerve kini tersedia sebagai **aplikasi desktop asli** untuk Windows, macOS, dan Linux.

Jalankan Nerve sebagai aplikasi desktop mandiri — tanpa terminal, tanpa browser, tanpa internet untuk model lokal. Aplikasi berbasis Electron meliputi:

- 🖥️ **Jendela Asli** — Jendela aplikasi khusus dengan integrasi baki sistem
- 🔄 **Mulai Otomatis** — Luncurkan Nerve saat login sistem
...
Saat diminimalkan, Nerve ada di baki sistem Anda dengan tindakan cepat:
...
**Tanpa biaya. Jangan pernah berhenti melakukan pengkodean.** Konfigurasikan ini sebagai satu kombo Nerve dan semua fallback terjadi secara otomatis — tidak pernah ada peralihan manual.
...
> Semua model di bawah **100% gratis tanpa memerlukan kartu kredit**. Nerve melakukan rute otomatis di antara keduanya ketika satu kuota habis — gabungkan semuanya untuk kombo $0 yang tidak dapat dipecahkan.
...
Nerve v3.6 dibangun sebagai platform operasional, bukan hanya proxy relai.
...
Ketika kuota, tarif, atau kesehatan gagal, Nerve secara otomatis berpindah ke kandidat berikutnya tanpa peralihan manual.
...
Nerve menyertakan kerangka evaluasi bawaan untuk menguji kualitas respons LLM terhadap rangkaian emas. Akses melalui **Analytics → Evals** di dasbor.

### Golden Set Bawaan

"Nerve Golden Set" yang dimuat sebelumnya berisi kasus uji untuk:
...
2. Jalankan `nerve_get_health`.
3. Jalankan `nerve_list_combos`.
...
**Kiat Pro:** Gunakan Opus untuk tugas kompleks, Soneta untuk kecepatan. Nerve melacak kuota per model!
...
- Perilaku rotasi: Nerve merutekan ke akun Codex berikutnya yang memenuhi syarat secara otomatis.
...
**Kiat Pro:** API yang kompatibel dengan OpenAI — bekerja secara lancar dengan terjemahan format Nerve!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from Nerve dashboard]
...
> **Catatan:** OpenClaw hanya berfungsi dengan Nerve lokal. Gunakan `127.0.0.1` alih-alih `localhost` untuk menghindari masalah resolusi IPv6.
...
Settings → API Configuration:
  ...
  Base URL: http://localhost:20128/v1
  API Key: [from Nerve dashboard]
  Model: if/kimi-k2-thinking
```

### OpenCode

**Langkah 1:** Tambahkan Nerve sebagai penyedia khusus:

```bash
opencode
/connect
# Select "Other" → Enter ID: "nerve" → Enter your Nerve API key
```
...
```bash
/models
# Select any Nerve model from the list
```

> **Tips:** Tambahkan model apa pun yang tersedia di titik akhir Nerve `/v1/models` Anda ke bagian `models`. Gunakan format `provider/model-id` dari dasbor Nerve Anda.
...
- Disegarkan secara otomatis oleh Nerve
...
- Nerve v1.0.6+ menyertakan validasi fallback melalui penyelesaian obrolan
...
> **⚠️ Penting bagi pengguna yang menjalankan Nerve di VPS, Docker, atau server jarak jauh mana pun**

Kredensial OAuth yang disertakan dalam Nerve didaftarkan **hanya untuk `localhost`**. Saat Anda mengakses Nerve di server jarak jauh (misalnya `https://nerve.myserver.com`), Google menolak autentikasi dengan:
...
- Nama: apa pun yang Anda suka (mis. `Nerve Remote`)
...
1. Nerve membuka URL otorisasi Google
...
4. Tempelkan URL tersebut ke bidang yang ditampilkan di modal koneksi Nerve
5. Klik **"Hubungkan"**
...
- **Situs Web**: [nerve.online](https://nerve.online)
- **Paket**: [npmjs.com/package/nerve](https://www.npmjs.com/package/nerve)
- **Pekerja Pelabuhan**: [hub.docker.com/r/diegosouzapw/nerve](https://hub.docker.com/r/diegosouzapw/nerve)
...
Nerve memiliki **218+ fitur yang direncanakan** di berbagai fase pengembangan. Berikut adalah bidang-bidang utamanya:
...
[![Contributors](https://contrib.rocks/image?repo=diegosouzapw/Nerve&max=100&columns=20&anon=1)](https://github.com/diegosouzapw/Nerve/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=diegosouzapw%2Fnerve&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/nerve&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/nerve&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=diegosouzapw/nerve&type=date&legend=top-left" />
 </picture>
</a>
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://nerve.online">nerve.online</a></sub>
</div>
