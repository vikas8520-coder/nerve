# Dokumentasi Server MCP Nerve (Bahasa Indonesia)
...
Nerve MCP sudah tersedia secara bawaan. Jalankan dengan:
...
| Alat                        | Deskripsi                                       |
| :-------------------------- | :---------------------------------------------- |
| `nerve_get_health`          | Kesehatan gateway, pemutus sirkuit, uptime      |
| `nerve_list_combos`         | Semua combo yang dikonfigurasi beserta modelnya |
| `nerve_get_combo_metrics`   | Metrik performa untuk combo tertentu            |
| `nerve_switch_combo`        | Ganti combo aktif berdasarkan ID/nama           |
| `nerve_check_quota`         | Status kuota per penyedia atau semua penyedia   |
| `nerve_route_request`       | Kirim penyelesaian chat melalui Nerve           |
| `nerve_cost_report`         | Analitik biaya untuk periode waktu tertentu     |
| `nerve_list_models_catalog` | Katalog model lengkap beserta kemampuannya      |

## Alat Lanjutan (8)

| Alat                           | Deskripsi                                                              |
| :----------------------------- | :--------------------------------------------------------------------- |
| `nerve_simulate_route`         | Simulasi routing percobaan dengan pohon fallback                       |
| `nerve_set_budget_guard`       | Anggaran sesi dengan tindakan degrade/block/alert                      |
| `nerve_set_resilience_profile` | Terapkan preset conservative/balanced/aggressive                       |
| `nerve_test_combo`             | Uji langsung semua model dalam combo melalui permintaan upstream nyata |
| `nerve_get_provider_metrics`   | Metrik terperinci untuk satu penyedia                                  |
| `nerve_best_combo_for_task`    | Rekomendasi kesesuaian tugas beserta alternatifnya                     |
| `nerve_explain_route`          | Jelaskan keputusan routing yang lalu                                   |
| `nerve_get_session_snapshot`   | Status sesi lengkap: biaya, token, kesalahan                           |
