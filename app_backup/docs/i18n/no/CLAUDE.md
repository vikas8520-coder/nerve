...
**Nerve** — enhetlig AI proxy/ruter. Ett endepunkt, 160+ LLM-leverandører, automatisk fallback.
...
Nerve har tre relaterte, men distinkte mekanismer for midlertidig feil. Hold deres
...
- **Datakatalog**: `DATA_DIR` miljøvariabel, standard til `~/.nerve/`
