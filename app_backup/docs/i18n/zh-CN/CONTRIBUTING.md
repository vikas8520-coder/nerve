...
感谢你对 Nerve 的关注！本文档将引导你从零开始参与项目贡献。
...
> **VPS 部署说明：** 远程镜像目录 `/usr/lib/node_modules/nerve/app/`
...
- **问题反馈**：[github.com/diegosouzapw/Nerve/issues](https://github.com/diegosouzapw/Nerve/issues)
