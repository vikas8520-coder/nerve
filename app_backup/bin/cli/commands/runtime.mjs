...
/**
 * Shared repair action used by both `nerve runtime repair` and the
 * top-level `nerve repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `nerve repair` invokes the SAME action
  // as `nerve runtime repair` (no duplicated logic). Surfaced in the
