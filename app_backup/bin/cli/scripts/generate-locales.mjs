...
const TRANSLATIONS = {
  ...
  bg: {
    common: {
      ...
      authRequired: "Необходима е автентикация. Задайте NERVE_API_KEY или изпълнете: nerve setup",
  ...
  es: {
    common: {
      ...
      authRequired: "Autenticación requerida. Configure NERVE_API_KEY o ejecute: nerve setup",
  ...
  fa: {
    common: {
      ...
      authRequired: "احراز هویت لازم است. NERVE_API_KEY را تنظیم کنید یا اجرا کنید: nerve setup",
  ...
  fr: {
    common: {
      ...
      authRequired: "Authentification requise. Définissez NERVE_API_KEY ou exécutez : nerve setup",
  ...
  id: {
    common: {
      ...
      authRequired: "Autentikasi diperlukan. Setel NERVE_API_KEY atau jalankan: nerve setup",
  ...
  it: {
    common: {
      ...
      authRequired: "Autenticazione richiesta. Impostare NERVE_API_KEY o eseguire: nerve setup",
  ...
  ja: {
    common: {
      ...
      authRequired: "認証が必要です。NERVE_API_KEYを設定するか実行してください: nerve setup",
  ...
  pl: {
    common: {
      ...
      authRequired: "Wymagane uwierzytelnienie. Ustaw NERVE_API_KEY lub uruchom: nerve setup",
  ...
  ru: {
    common: {
      ...
      authRequired: "Требуется аутентификация. Установите NERVE_API_KEY или выполните: nerve setup",
  ...
  sk: {
    common: {
      ...
      authRequired: "Vyžaduje sa overenie. Nastavte NERVE_API_KEY alebo spustite: nerve setup",
  ...
  "uk-UA": {
    common: {
      ...
      authRequired: "Потрібна автентифікація. Встановіть NERVE_API_KEY або виконайте: nerve setup",
