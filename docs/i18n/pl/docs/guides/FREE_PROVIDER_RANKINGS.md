...
> **TL;DR**: Nerve rankinguje swoje **darmowe** providery według jakości modeli, używając **wyników ELO Arena AI
...
Nerve agreguje 160+ providerów, z których wiele udostępnia **darmowy tier** (no-auth,
...
Kategorie rankingu mapują się na kategorie zadań Nerve:

| Ranking Arena | Kategorie zadań Nerve                         |
| ------------- | ------------------------------------------------- |
...
- Jest **nieblokująca i nigdy nie jest fatalna** — jeśli fetch upstreamu się nie uda, Nerve dalej
...
przez Nerve, dzięki czemu modele da się znaleźć pod dowolną nazwą.
