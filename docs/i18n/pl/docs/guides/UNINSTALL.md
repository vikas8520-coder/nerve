---
title: "Nerve — Przewodnik deinstalacji"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Nerve — Przewodnik deinstalacji
...
Ten przewodnik opisuje, jak czysto usunąć Nerve z systemu.

---

## Szybka deinstalacja (v3.6.2+)

Nerve udostępnia dwa wbudowane skrypty do czystego usunięcia:
...
To usuwa aplikację Nerve, ale **zachowuje** bazę danych, konfiguracje, klucze API oraz ustawienia providerów w `~/.nerve/`. Użyj tej opcji, jeśli planujesz ponowną instalację i chcesz zachować swoją konfigurację.
...
- Pliki logów
- Wszystkie pliki w katalogu `~/.nerve/`
...
- Otwórz `Settings → Apps → Nerve → Uninstall`
- Lub uruchom deinstalator NSIS z katalogu instalacji

**macOS:**

- Przeciągnij `Nerve.app` z `/Applications` do Kosza
- Usuń dane: `rm -rf ~/Library/Application Support/nerve`

**Linux:**

- Usuń plik AppImage
- Usuń dane: `rm -rf ~/.nerve`
...
Nerve domyślnie przechowuje dane w następujących lokalizacjach:
