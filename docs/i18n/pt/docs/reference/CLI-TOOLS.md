# CLI Tools Setup Guide — Nerve (Português (Portugal))
...
to use **Nerve** as the unified backend, giving you centralized key management,
...
1. Open the Nerve dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For Nerve integration,
> enable **Cloud Endpoint** in Nerve Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your Nerve key

---

## Dashboard Auto-Configuration

The Nerve dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into Nerve — no installation needed.
They run as internal routes and use Nerve's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | Nerve not running   | `pm2 start nerve`                      |
...
```bash
# Install all CLIs and configure for Nerve (replace with your key and server URL)
