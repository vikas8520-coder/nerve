...
Jika Anda menemukan kerentanan keamanan di Nerve, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/diegosouzapw/Nerve/security/advisories/new)
...
Nerve menerapkan model keamanan berlapis:
