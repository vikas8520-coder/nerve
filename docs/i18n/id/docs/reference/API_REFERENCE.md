...
Referensi lengkap untuk semua titik akhir API Nerve.
...
| ------------------------ | --------- | ------------------------------------------------------------ |
| `X-Nerve-No-Cache`   | Permintaan | Atur ke `true` untuk melewati cache                          |
| `X-Nerve-Progress`   | Permintaan | Atur ke `true` untuk event progres                           |
...
| `X-Nerve-Cache`      | Respons   | `HIT` atau `MISS` (non-streaming)                            |
| `X-Nerve-Idempotent` | Respons   | `true` jika dideduplikasi                                    |
| `X-Nerve-Progress`   | Respons   | `enabled` jika pelacakan progres aktif                       |
| `X-Nerve-Session-Id` | Respons   | ID sesi efektif yang digunakan Nerve                     |
