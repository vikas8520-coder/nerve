...
- sebelum akun aktif habis, Nerve menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, Nerve menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, Nerve menghasilkan ringkasan handoff
...
Nerve menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, Nerve mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
