# Nerve — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi Nerve pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout Nerve Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [nerveCloud/README.md](../nerveCloud/README.md).
...
| 20128 | Nerve   | Hanya localhost (melalui nginx) |
