...
import { normalizeClaudeHaikuConstraints } from "@nerve/open-sse/services/claudeHaikuConstraints.ts";
...
// Several Nerve paths can still emit these on Haiku targets:
