...
const BIN_ENTRY = path.join(ROOT, "bin", "nerve.mjs");
...
test("every bin/nerve.mjs local import is enforced by check:pack-artifact", () => {
  // The CLI boot path (bin/nerve.mjs → bin/cli/*) is covered by allowlist PREFIXES,
