...
// Regression guard for #3883: the @nerve/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@nerve/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@nerve/opencode-plugin/tsup.config.ts", import.meta.url);
