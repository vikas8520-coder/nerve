...
import { REGISTRY } from "@nerve/open-sse/config/providers/index.ts";
import { FREE_MODEL_BUDGETS } from "@nerve/open-sse/config/freeModelCatalog.data.ts";
...
// fabricated (copied from Nerve's own Anthropic catalog) and live-verified
