/**
 * Global Type Declarations for Nerve
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    NERVE_PUBLIC_BASE_URL?: string;
    NERVE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    NERVE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    NERVE_BASE_URL?: string;
    NERVE_DISABLE_BACKGROUND_SERVICES?: string;
    NERVE_PORT?: string;
