      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          <button
            ...
            className="hidden sm:flex h-9 items-center justify-center rounded-lg px-4 bg-[#00FF9F] hover:bg-[#00CC7F] transition-all text-white text-sm font-bold shadow-[0_0_15px_rgba(0, 255, 159,0.4)] hover:shadow-[0_0_20px_rgba(0, 255, 159,0.6)]"
          >
            {t("getStarted")}
          </button>
          <button
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[#2D333B] bg-[#0B0E14]/95 backdrop-blur-md">
          <div className="flex flex-col gap-4 p-6">
            ...
            <button
              onClick={() => router.push("/dashboard")}
              className="h-9 rounded-lg bg-[#00FF9F] hover:bg-[#00CC7F] text-white text-sm font-bold"
            >
              {t("getStarted")}
            </button>
          </div>
