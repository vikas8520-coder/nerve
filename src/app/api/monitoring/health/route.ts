...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@nerve/open-sse/services/rateLimitManager"),
      import("@nerve/open-sse/services/accountFallback"),
      import("@nerve/open-sse/services/requestDedup.ts"),
      import("@nerve/open-sse/services/quotaMonitor.ts"),
      import("@nerve/open-sse/services/sessionManager.ts"),
