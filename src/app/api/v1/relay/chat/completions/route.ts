 ...
 * to the internal Nerve chat completions pipeline.
 */
...
import { getProviderPluginManifestEntryForModel } from "@nerve/open-sse/config/providerPluginManifestRegistry.ts";
import { getProviderPluginManifestHeader } from "@nerve/open-sse/config/providerPluginManifestUrl.ts";
