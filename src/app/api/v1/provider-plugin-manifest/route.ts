...
import { generateProviderPluginManifest } from "@nerve/open-sse/config/providerPluginManifestRegistry.ts";
...
import type {
  ...
  ProviderPluginModel,
} from "@nerve/open-sse/config/providerPluginManifest.ts";
