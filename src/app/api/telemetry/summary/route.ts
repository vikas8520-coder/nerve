...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@nerve/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@nerve/open-sse/services/sessionManager.ts");
