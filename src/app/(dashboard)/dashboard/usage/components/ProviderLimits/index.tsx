...
const LS_PURCHASE_FILTER = "nerve:limits:purchaseFilter";
const LS_STATUS_FILTER = "nerve:limits:statusFilter";
const LS_ENV_FILTER = "nerve:limits:envFilter";
const LS_PROVIDER_FILTER = "nerve:limits:providerFilter";
            ...
            {PURCHASE_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  style={{
                    border: active
                      ? "1px solid var(--color-primary, #00FF9F)"
                      : "1px solid var(--color-border)",
                    background: active ? "rgba(229,77,94,0.1)" : "transparent",
                    color: active ? "var(--color-primary, #00FF9F)" : "var(--color-text-muted)",
                  }}
                >
