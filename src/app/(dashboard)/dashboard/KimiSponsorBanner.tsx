...
const KIMI_CODING_AFF_URL = "https://www.kimi.com/code?aff=nerve";
...
const DISMISS_STORAGE_KEY = "nerve-kimi-sponsor-banner-dismissed-v1";
// Same-tab signal for the dismiss button, since writing localStorage doesn't
// fire a "storage" event in the tab that wrote it.
const DISMISS_EVENT = "nerve:kimi-sponsor-banner-dismissed";
...
/**
 * Dismissable banner announcing the Kimi (Moonshot AI) official Nerve
...
export default function KimiSponsorBanner() {
  ...
  return (
    <div
      role="complementary"
      aria-label={t("title")}
      className="mb-4 flex flex-col gap-3 rounded-lg border border-[#00FF9F]/30 bg-[#00FF9F]/5 px-4 py-3 dark:bg-[#00FF9F]/10 sm:flex-row sm:items-center sm:justify-between"
    >
      <div className="flex min-w-0 items-start gap-3">
        <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-[#00FF9F]/10">
      ...
      <div className="flex shrink-0 items-center gap-3 self-end sm:self-auto">
        <div className="flex flex-col items-end gap-0.5">
          <a
            ...
            className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-lg bg-[#00FF9F] px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:brightness-110"
          >
            {t("cta")}
