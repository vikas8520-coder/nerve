 ...
 * trace out of Nerve into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The Nerve capture source
...
const CREATOR_NAME = "Nerve Traffic Inspector";
