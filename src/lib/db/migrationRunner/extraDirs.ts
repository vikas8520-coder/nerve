 ...
 * space: `NNN_name.sql` is recorded in `_nerve_migrations` as `NNN`. That
 ...
 * namespace:
 *
 *   NERVE_EXTRA_MIGRATIONS_DIRS="ee=/opt/app/enterprise/db/migrations"
 *
...
export const EXTRA_MIGRATIONS_DIRS_ENV = "NERVE_EXTRA_MIGRATIONS_DIRS";
