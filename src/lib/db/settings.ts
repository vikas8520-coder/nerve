...
import { PROVIDER_ID_TO_ALIAS } from "@nerve/open-sse/config/providerModels.ts";
...
export async function resolveProxyForConnection(
  ...
  try {
    const { selectWorkingProxyFallback } = await import("@nerve/open-sse/utils/proxyFallback");
