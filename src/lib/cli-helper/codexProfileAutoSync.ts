...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the NERVE_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("NERVE_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `nerve setup-codex`
