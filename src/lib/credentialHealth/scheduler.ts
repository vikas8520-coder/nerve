...
function getSchedulerState() {
  if (!globalThis.__nerveCredentialHC) {
    globalThis.__nerveCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__nerveCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.NERVE_DISABLE_CREDENTIAL_HEALTH_CHECK;
