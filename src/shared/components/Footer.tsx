...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/diegosouzapw/Nerve/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/diegosouzapw/Nerve", external: true },
    { label: "Blog", href: "https://github.com/diegosouzapw/Nerve/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/diegosouzapw/Nerve/issues/new/choose",
      external: true,
    },
