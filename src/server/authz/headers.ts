...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-nerve-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-nerve-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-nerve-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-nerve-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-nerve-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-nerve-cli-token";
 ...
 * token matches this process's NERVE_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-nerve-peer-ip";
 ...
 * proxy hop (e.g. Nerve behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-nerve-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-nerve-peer-locality";
