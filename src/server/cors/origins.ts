 ...
 *
 * Source of truth for which browser origins may call Nerve over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-nerve-connection, x-internal-test, accept";
