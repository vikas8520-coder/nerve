/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced Nerve MCP tools.
 *
 ...
 *
 * Each tool wraps existing Nerve API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "nerve_get_health",
  description:
    "Returns the current health status of Nerve including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: nerve_get_combo_metrics ---
...
> = {
  ...
  description:
    "Sends a chat completion request through Nerve's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: nerve_list_models_catalog ---
...
> = {
  name: "nerve_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "nerve_web_search",
  description:
    "Performs a web search using Nerve's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "nerve_web_fetch",
  description:
    "Fetches and extracts content from a URL using Nerve's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 10: nerve_set_budget_guard ---
...
// --- Tool 11: nerve_set_routing_strategy ---
...
> = {
  name: "nerve_set_routing_strategy",
  description:
...
// --- Tool 12: nerve_set_resilience_profile ---
...
> = {
  name: "nerve_set_resilience_profile",
  description:
...
// --- Tool 14: nerve_get_provider_metrics ---
...
> = {
  name: "nerve_get_provider_metrics",
  description:
...
// --- Tool 15: nerve_best_combo_for_task ---
...
> = {
  name: "nerve_best_combo_for_task",
  description:
...
// --- Tool 17: nerve_get_session_snapshot ---
...
> = {
  name: "nerve_get_session_snapshot",
  description:
...
> = {
  name: "nerve_db_health_check",
  description:
    "Diagnoses Nerve database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "nerve_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into Nerve. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "nerve_compression_configure",
  description:
...
> = {
  name: "nerve_set_compression_engine",
...
> = {
  name: "nerve_list_compression_combos",
...
> = {
  name: "nerve_compression_combo_stats",
...
> = {
  name: "nerve_agent_skills_list",
  description:
    "List Nerve agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "nerve_agent_skills_coverage",
  description:
