/**
 * Nerve MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. nerve_pool_status   — Get pool stats for one or all providers
 *   2. nerve_pool_sessions — List per-session details for a provider's pool
 *   3. nerve_pool_reset    — Shut down and recreate a pool
 *   4. nerve_pool_warm     — Warm up a pool to a target session count
 *   5. nerve_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  ...
  nerve_browser_pool_status: {
    name: "nerve_browser_pool_status",
    description:
