...
function responseHeaders(contentType: string, metadata: Record<string, string>): Headers {
  ...
  const headerNames: Record<string, string> = {
    operation: "X-Nerve-Claude-Web-Operation",
    conversation_id: "X-Nerve-Claude-Web-Conversation-Id",
    parent_message_uuid: "X-Nerve-Claude-Web-Parent-Message-Uuid",
    assistant_message_uuid: "X-Nerve-Claude-Web-Assistant-Message-Uuid",
  };
