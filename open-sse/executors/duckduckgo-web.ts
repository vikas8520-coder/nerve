...
function shouldUseBrowserBacked(): boolean {
  ...
  const poolFlag = process.env.NERVE_BROWSER_POOL;
 ...
 * retired id Nerve historically advertised to the current wire id served by
...
export class DuckDuckGoWebExecutor extends BaseExecutor {
  ...
  async execute(input: ExecuteInput) {
    ...
    // Browser-backed path: opt-in via NERVE_BROWSER_POOL=on or
