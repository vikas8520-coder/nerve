 ...
 * Nerve, however, holds the streaming response until `ensureStreamReadiness`
...
const KEEPALIVE_FRAME = ENCODER.encode(": nerve-keepalive\n\n");
...
export const OPENAI_KEEPALIVE_FRAME = ENCODER.encode(
  'data: {"id":"nerve-keepalive","object":"chat.completion.chunk","created":0,"model":"nerve","choices":[{"index":0,"delta":{},"finish_reason":null}]}\n\n'
);
...
const RESPONSES_STARTUP_ITEM_ID = "rs_nerve_keepalive";
const STARTUP_THINKING_TEXT = "Nerve: got request, sending to provider";
...
export type EarlyStreamKeepaliveOptions = {
   ...
   * (`: nerve-keepalive`). Anthropic-format routes (/v1/messages) must pass
