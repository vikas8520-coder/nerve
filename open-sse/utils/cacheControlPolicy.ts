 ...
 * vs. applying Nerve's own caching strategy.
 *
 ...
 * strategies) forced Nerve to strip the client's markers and re-derive
 ...
 * @returns true if cache_control should be preserved, false if Nerve should manage it
 */
