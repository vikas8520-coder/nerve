...
const PATCH_STATE_KEY = Symbol.for("nerve.proxyFetch.state");
 ...
 *
 * This remains disabled unless NERVE_CONTROL_PLANE_PROXY_DIRECT_FALLBACK is enabled
...
async function patchedFetch(
  ...
  if (
    ...
    if (process.env.NERVE_PROXY_FETCH_DEBUG === "true") {
