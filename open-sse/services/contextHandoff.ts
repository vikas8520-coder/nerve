...
export const SKIP_UNIVERSAL_HANDOFF_FLAG = "_nerveSkipUniversalHandoff";
...
async function generateHandoffAsync(options: {
  ...
  const summaryBody = {
    ...
    temperature: 0.1,
    _nerveSkipContextRelay: true,
    _nerveInternalRequest: "context-handoff",
  };
...
async function generateUniversalHandoffAsync(options: {
  ...
  const summaryBody: Record<string, unknown> = {
    ...
    temperature: 0.1,
    _nerveSkipContextRelay: true,
    _nerveInternalRequest: "universal-handoff",
  };
